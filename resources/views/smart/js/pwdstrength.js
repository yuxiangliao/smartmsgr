...
function ClientPerfectPassword()//完美
{
return (IsLongEnough(ClientPerfectPassword.arguments[0], "10") &&
SpansEnoughCharacterSets(ClientPerfectPassword.arguments[0], "3") &&
(!(IsCloseVariationOfAWordInDictionary(ClientPerfectPassword.arguments[0], "0.6", 
ClientPerfectPassword.arguments[1], ClientPerfectPassword.arguments[2]))));
}

function ClientStrongPassword()//高
{
return (IsLongEnough(ClientStrongPassword.arguments[0], "8") &&
SpansEnoughCharacterSets(ClientStrongPassword.arguments[0], "3") &&
(!(IsCloseVariationOfAWordInDictionary(ClientStrongPassword.arguments[0], "0.6", 
ClientStrongPassword.arguments[1], ClientStrongPassword.arguments[2]))));
}
function ClientMiddleStrongPassword()//中高
{
return (IsLongEnough(ClientMiddleStrongPassword.arguments[0], "10") &&SpansEnoughCharacterSets(ClientMiddleStrongPassword.arguments[0], "2") &&(!(FoundInDictionary(ClientMiddleStrongPassword.arguments[0], ClientMiddleStrongPassword.arguments[1], ClientMiddleStrongPassword.arguments[2]))))||(IsLongEnough(ClientMiddleStrongPassword.arguments[0], "6")&&!IsLongEnough(ClientMiddleStrongPassword.arguments[0], "8")&&SpansEnoughCharacterSets(ClientMiddleStrongPassword.arguments[0], "3"));
}
function ClientMiddlePassword()//中
{
return IsLongEnough(ClientMiddlePassword.arguments[0], "8") &&
SpansEnoughCharacterSets(ClientMiddlePassword.arguments[0], "2");
}

function ClientMiddleWeakPassword()//中低
{
return IsLongEnough(ClientMiddleWeakPassword.arguments[0], "12")||(IsLongEnough(ClientMiddleWeakPassword.arguments[0], "6") &&!IsLongEnough(ClientMiddleWeakPassword.arguments[0], "8")&&SpansEnoughCharacterSets(ClientMiddleWeakPassword.arguments[0], "2"));
}

function ClientWeakPassword()//低
{
return IsLongEnough(ClientWeakPassword.arguments[0], "8");
}

function ClientSoWeakPassword()//非常低
{
return !(IsLongEnough(ClientSoWeakPassword.arguments[0], "6"));
}
